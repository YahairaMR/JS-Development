...
const loginUser = async (userData) => {
    try {
        ...
        // to create a token use jwt.sign({ payload}, secretKey)
        // payload - data taht we want to store with the token (can be whatever you want, typically for private user information)
